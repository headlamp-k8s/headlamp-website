...
This is just the beginning! We’re continuously working on improving the cert-manager plugin based on user feedback. If you have suggestions or encounter any issues, please contribute via [GitHub](https://github.com/headlamp-k8s/headlamp) or join our [Slack channel](https://slack.k8s.io/).
