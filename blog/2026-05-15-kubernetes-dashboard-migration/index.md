...
description: A practical, step-by-step guide to moving from the archived Kubernetes Dashboard to Headlamp, covering install, RBAC, multi-cluster, daily workflows, and cleanup.
tags:
  ['kubernetes', 'ui', 'headlamp', 'migration', 'kubernetes-dashboard', 'guide']
image: ./splash.png
authors: ['will-case', 'vincent-t']
---
