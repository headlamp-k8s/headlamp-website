...
If you want to try it, [view our documentation](https://headlamp.dev/docs/latest/learn/holmesgpt), open Headlamp, enable the AI Assistant, and connect HolmesGPT. The next time an alert fires, you can go from signals to answers without leaving the UI.
